...
insert into branches (id, organization_id, restaurant_id, name) values
  ('00000000-0000-0000-0000-00d1c0000a1a', '00000000-0000-0000-0000-00d1c0000a00', '00000000-0000-0000-0000-00d1c0000a10', 'Branch (kds)');
...
-- Helper: one order.submit op through app.sync_push with an explicit dispatch_mode.
create or replace function pg_temp.dp_submit(
  p_op text, p_order uuid, p_item uuid, p_price bigint, p_mode text)
...
select ok((select o.status = 'completed' and o.dispatch_mode = 'direct_print' and o.revision = 3
             from orders o where o.id = '00000000-0000-0000-0000-00d1c00d0002'),
  'B2: persisted completed + dispatch_mode=direct_print at revision 3 (insert+serve+complete)'); -- 11

...
-- manager (authorized) and an UNAUTHORIZED cashier carrying explicit deny overrides
-- (permissions.void_order='false' + apply_discount='false',
-- STAFF-CASHIER-PERMISSIONS-001 -- a plain default cashier would now be authorized),
-- same device
...
insert into memberships (id, app_user_id, organization_id, restaurant_id, branch_id, role, permissions) values
  ...
  ('00000000-0000-0000-0000-00000000ab02', '00000000-0000-0000-0000-00000000ee02', '00000000-0000-0000-0000-0000000000a0', '00000000-0000-0000-0000-0000000000a1', '00000000-0000-0000-0000-00000000a1b1', 'cashier', '{"void_order":"false","apply_discount":"false"}'::jsonb);

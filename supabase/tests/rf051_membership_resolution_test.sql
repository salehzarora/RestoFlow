...
insert into employee_profiles (id, organization_id, restaurant_id, branch_id, app_user_id, membership_id, pin_credential_ref) values
  ('00000000-0000-0000-0000-0000000ef0a0', '00000000-0000-0000-0000-0000000000a0', '00000000-0000-0000-0000-0000000000a1', '00000000-0000-0000-0000-00000000a1b1', '00000000-0000-0000-0000-0000000000aa', '00000000-0000-0000-0000-0000000ab0a1', extensions.crypt('ref:A', extensions.gen_salt('bf'))),  -- authoritative
  ('00000000-0000-0000-0000-0000000ef0b0', '00000000-0000-0000-0000-0000000000a0', '00000000-0000-0000-0000-0000000000a1', '00000000-0000-0000-0000-00000000a1b1', '00000000-0000-0000-0000-0000000000bb', null, extensions.crypt('ref:B', extensions.gen_salt('bf'))),                                       -- fallback (unambiguous)
  ('00000000-0000-0000-0000-0000000ef0c0', '00000000-0000-0000-0000-0000000000a0', '00000000-0000-0000-0000-0000000000a1', '00000000-0000-0000-0000-00000000a1b1', '00000000-0000-0000-0000-0000000000cc', null, extensions.crypt('ref:C', extensions.gen_salt('bf'))),                                       -- fallback (ambiguous)
  ('00000000-0000-0000-0000-0000000ef0d0', '00000000-0000-0000-0000-0000000000a0', '00000000-0000-0000-0000-0000000000a1', '00000000-0000-0000-0000-00000000a1b1', null, null, extensions.crypt('ref:D', extensions.gen_salt('bf')));                                                                        -- empty (no app_user, no membership_id)

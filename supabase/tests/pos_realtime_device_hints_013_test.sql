...
insert into auth.users (id, email) values
  ...
  -- SINGLE-FLIP principals (mutation coverage: each isolates exactly ONE
  -- validity predicate of app.device_can_receive_branch_hints):
  ('00000000-0000-0000-0000-00d013aa0009', 'g013-d9@example.test'),  -- ds.is_active
  ('00000000-0000-0000-0000-00d013aa0010', 'g013-d10@example.test'), -- ds.revoked_at
  ('00000000-0000-0000-0000-00d013aa0011', 'g013-d11@example.test'), -- dp.status
  ('00000000-0000-0000-0000-00d013aa0012', 'g013-d12@example.test'), -- dp.revoked_at
  ('00000000-0000-0000-0000-00d013aa0013', 'g013-d13@example.test'), -- dp.deleted_at
  ('00000000-0000-0000-0000-00d013aa0014', 'g013-d14@example.test'), -- d.is_active
  ('00000000-0000-0000-0000-00d013aa0015', 'g013-d15@example.test'); -- d.deleted_at
...
insert into devices (id, organization_id, restaurant_id, branch_id, device_type) values
  ...
  ('00000000-0000-0000-0000-00d013dd0900', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', 'pos'),
  ('00000000-0000-0000-0000-00d013dd1000', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', 'pos'),
  ('00000000-0000-0000-0000-00d013dd1100', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', 'pos'),
  ('00000000-0000-0000-0000-00d013dd1200', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', 'pos'),
  ('00000000-0000-0000-0000-00d013dd1300', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', 'pos'),
  ('00000000-0000-0000-0000-00d013dd1400', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', 'pos'),
  ('00000000-0000-0000-0000-00d013dd1500', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', 'pos');
insert into device_pairings (id, organization_id, restaurant_id, branch_id, device_id, status) values
  ...
  ('00000000-0000-0000-0000-00d013fa0900', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd0900', 'active'),
  ('00000000-0000-0000-0000-00d013fa1000', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1000', 'active'),
  ('00000000-0000-0000-0000-00d013fa1100', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1100', 'active'),
  ('00000000-0000-0000-0000-00d013fa1200', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1200', 'active'),
  ('00000000-0000-0000-0000-00d013fa1300', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1300', 'active'),
  ('00000000-0000-0000-0000-00d013fa1400', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1400', 'active'),
  ('00000000-0000-0000-0000-00d013fa1500', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1500', 'active');
...
insert into device_sessions (id, organization_id, restaurant_id, branch_id, device_id, device_pairing_id, auth_user_id, expires_at) values
  ...
  ('00000000-0000-0000-0000-00d013050900', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd0900', '00000000-0000-0000-0000-00d013fa0900', '00000000-0000-0000-0000-00d013aa0009', now() + interval '1 day'),
  ('00000000-0000-0000-0000-00d013051000', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1000', '00000000-0000-0000-0000-00d013fa1000', '00000000-0000-0000-0000-00d013aa0010', now() + interval '1 day'),
  ('00000000-0000-0000-0000-00d013051100', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1100', '00000000-0000-0000-0000-00d013fa1100', '00000000-0000-0000-0000-00d013aa0011', now() + interval '1 day'),
  ('00000000-0000-0000-0000-00d013051200', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1200', '00000000-0000-0000-0000-00d013fa1200', '00000000-0000-0000-0000-00d013aa0012', now() + interval '1 day'),
  ('00000000-0000-0000-0000-00d013051300', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1300', '00000000-0000-0000-0000-00d013fa1300', '00000000-0000-0000-0000-00d013aa0013', now() + interval '1 day'),
  ('00000000-0000-0000-0000-00d013051400', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1400', '00000000-0000-0000-0000-00d013fa1400', '00000000-0000-0000-0000-00d013aa0014', now() + interval '1 day'),
  ('00000000-0000-0000-0000-00d013051500', '00000000-0000-0000-0000-00d01300a000', '00000000-0000-0000-0000-00d01300a100', '00000000-0000-0000-0000-00d013a1b100', '00000000-0000-0000-0000-00d013dd1500', '00000000-0000-0000-0000-00d013fa1500', '00000000-0000-0000-0000-00d013aa0015', now() + interval '1 day');
...
-- Revoke device 4's session + pairing AFTER the emission fixtures (the
-- realistic combined revocation).
...
-- SINGLE-FLIP mutations (each invalidates exactly ONE predicate, so deleting
-- that predicate from the helper turns exactly one assertion red):
update device_sessions set is_active=false      where id='00000000-0000-0000-0000-00d013050900';
update device_sessions set revoked_at=now()     where id='00000000-0000-0000-0000-00d013051000';
update device_pairings set status='suspended'   where id='00000000-0000-0000-0000-00d013fa1100';
update device_pairings set revoked_at=now()     where id='00000000-0000-0000-0000-00d013fa1200';
update device_pairings set deleted_at=now()     where id='00000000-0000-0000-0000-00d013fa1300';
update devices set is_active=false              where id='00000000-0000-0000-0000-00d013dd1400';
update devices set deleted_at=now()             where id='00000000-0000-0000-0000-00d013dd1500';
...
-- ===== (26-32) single-flip mutation coverage: each check kills exactly one
-- helper predicate if it is ever deleted =====================================
set local realtime.topic = 'kds:branch:00000000-0000-0000-0000-00d013a1b100';

set local request.jwt.claim.sub = '00000000-0000-0000-0000-00d013aa0009';
select is((select count(*) from realtime.messages)::int, 0,
  'ds.is_active=false ALONE denies (session deactivated, nothing else touched)');

set local request.jwt.claim.sub = '00000000-0000-0000-0000-00d013aa0010';
select is((select count(*) from realtime.messages)::int, 0,
  'ds.revoked_at set ALONE denies');

set local request.jwt.claim.sub = '00000000-0000-0000-0000-00d013aa0011';
select is((select count(*) from realtime.messages)::int, 0,
  'dp.status <> active ALONE denies (suspended pairing)');

set local request.jwt.claim.sub = '00000000-0000-0000-0000-00d013aa0012';
select is((select count(*) from realtime.messages)::int, 0,
  'dp.revoked_at set ALONE denies');

set local request.jwt.claim.sub = '00000000-0000-0000-0000-00d013aa0013';
select is((select count(*) from realtime.messages)::int, 0,
  'dp.deleted_at set ALONE denies');

set local request.jwt.claim.sub = '00000000-0000-0000-0000-00d013aa0014';
select is((select count(*) from realtime.messages)::int, 0,
  'd.is_active=false ALONE denies');

set local request.jwt.claim.sub = '00000000-0000-0000-0000-00d013aa0015';
select is((select count(*) from realtime.messages)::int, 0,
  'd.deleted_at set ALONE denies');

-- ===== (33-34) decommission gates (R-003/R-007): a tombstoned branch, then a
-- tombstoned restaurant, cut off a principal that DEMONSTRABLY received above
-- (assertion 14 proved aa0001 >= 1 on this same topic — non-vacuous) =========
reset role;
update branches set deleted_at = now() where id = '00000000-0000-0000-0000-00d013a1b100';
set local role authenticated;
set local request.jwt.claim.sub = '00000000-0000-0000-0000-00d013aa0001';
set local realtime.topic = 'kds:branch:00000000-0000-0000-0000-00d013a1b100';
select is((select count(*) from realtime.messages)::int, 0,
  'a SOFT-DELETED branch stops serving its devices (decommission, R-003/R-007)');

reset role;
update branches set deleted_at = null where id = '00000000-0000-0000-0000-00d013a1b100';
update restaurants set deleted_at = now() where id = '00000000-0000-0000-0000-00d01300a100';
set local role authenticated;
set local request.jwt.claim.sub = '00000000-0000-0000-0000-00d013aa0001';
set local realtime.topic = 'kds:branch:00000000-0000-0000-0000-00d013a1b100';
select is((select count(*) from realtime.messages)::int, 0,
  'a SOFT-DELETED restaurant stops serving its branches'' devices (decommission)');

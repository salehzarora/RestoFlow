...
-- the default look). Fifteen keys now (the exact key SET is pinned by
...
select is(
  ...
  16, 'a pos_tables row carries the sixteen keys (eight prior + five 021 layout keys + two 118 preset keys + the 120 visual_material)');
select ok(

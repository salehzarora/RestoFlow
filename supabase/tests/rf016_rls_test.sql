...
select throws_ok($$ insert into devices (organization_id,restaurant_id,branch_id,device_type) values ('00000000-0000-0000-0000-0000000000a0','00000000-0000-0000-0000-0000000000a1','00000000-0000-0000-0000-00000000a1b1','pos') $$, '42501', NULL, 'cashier @ RA1: direct INSERT of a device is DENIED (RF-059 A2: device writes are RPC-only / revoked)');

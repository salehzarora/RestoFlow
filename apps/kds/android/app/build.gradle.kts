...
//
// This block is duplicated verbatim in apps/pos. A shared script plugin was
...
android {
    ...
    defaultConfig {
        // RestoFlow KDS — pilot Android package (ANDROID-001).
        applicationId = "com.restoflow.kds"

        ...
        ref
            ...
            .set(
              PosOpenShift(
                ...
                // B1 + Finding 2: carry the authorization verdict so the close UI shows
                // an owner-mismatch OR a capability-denied state (not a close form)
                // rather than a form the server would refuse.

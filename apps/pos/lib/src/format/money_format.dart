...
/// Formats integer minor-unit money for display in the POS.
///
...
///
/// The class survives (rather than 51 call sites being rewritten) because the
...
class MoneyFormatter {
  ...
  static String formatSignedDeltaMinor(int deltaMinor, String currencyCode) =>
      formatSignedCurrencyMinor(deltaMinor, currencyCode);
}

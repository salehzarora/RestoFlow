...
/** Arabic, ON DEMAND: the he root fetches it when Arabic tenant text is laid out (its fallback face is metric-tuned, storefront.module.css). */
export const rubikArabicLazy = localFont({

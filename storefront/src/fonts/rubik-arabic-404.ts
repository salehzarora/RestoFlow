...
/** Arabic, ON DEMAND, for the 404 document ONLY: a module of its own, so the not-found boundary (part of every route's tree) shares no chunk with a root's preloaded set. */
export const rubikArabic404 = localFont({

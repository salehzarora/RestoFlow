...
class FlutterLogoDecoder {
  ...
  Future<DecodedLogoImage> decode(Uint8List bytes) async {
    ...
    // 2. Header-only dimensions so we can reject oversized images BEFORE the
    //    full frame is allocated.
    ...
    // 3. Full decode (native size) and extract raw RGBA.
    ui.Codec codec;
    try {

...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String storefrontLogoSourceRefused(String reason) {
    return '$reason لا يمكن إنشاء شعار واجهة المتجر إلا من شعار الإيصال: لنشر شعار، استبدل شعار الإيصال في «شعار الإيصال» أعلاه بصورة PNG أو JPEG أو WebP لا تتجاوز 8 ميغابكسل (8,388,608 بكسل)، ولا يتجاوز كل ضلع منها 8192 بكسل، ولا يزيد عرضها على ثمانية أضعاف ارتفاعها (ولا ارتفاعها على ثمانية أضعاف عرضها). سيؤدي ذلك أيضًا إلى تغيير الشعار المطبوع على الإيصالات.';
  }

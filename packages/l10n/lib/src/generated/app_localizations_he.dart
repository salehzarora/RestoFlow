...
class AppLocalizationsHe extends AppLocalizations {
  ...
  @override
  String get receiptDemoRestaurantName => 'ביסטרו לדוגמה';
  ...
  String get storefrontHoursTouchingError =>
      'טווחי הזמן האלה צמודים זה לזה. אחד אותם לטווח פתיחה רציף אחד.';

  @override
  String get storefrontBlockerHoursTouching =>
      'שעות הפתיחה השמורות כוללות טווחים צמודים: אחד אותם לטווח רציף אחד ב„שעות פתיחה” ואז שמור.';

  @override
  String storefrontLogoSourceRefused(String reason) {
    return '$reason את הלוגו של דף החנות אפשר ליצור רק מהלוגו בקבלה: כדי לפרסם לוגו, החלף את הלוגו בקבלה ב„לוגו בקבלה” שלמעלה בתמונת PNG, JPEG או WebP של עד 8 מגה-פיקסל (8,388,608 פיקסלים), עד 8192 פיקסלים בכל צלע, ושרוחבה אינו עולה על פי 8 מגובהה (וגובהה אינו עולה על פי 8 מרוחבה). תמונת PNG בעומק 16 סיביות צריכה להיות קטנה מכ-4 מגה-פיקסל, ותמונת JPEG מדורגת שנשמרה בלי הקטנת רזולוציית הצבע — קטנה מכ-5 מגה-פיקסל. הפעולה הזו משנה גם את הלוגו שמודפס בקבלות.';
  }
